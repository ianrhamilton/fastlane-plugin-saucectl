...
describe Fastlane::Actions::SauceConfigAction do
  describe 'saucelabs runner action' do
    ...
    it 'should create config.yml file for android espresso without setting test distribution and path to tests' do
      ...
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"espresso", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "espresso"=>{"app"=> File.expand_path("my-demo-app-android/myTestApp.apk"), "testApp"=> File.expand_path("my-demo-app-android/myTestRunner.apk")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{"name"=>"unit-test-123-Android GoogleApi Emulator", "testOptions"=>{"clearPackageData"=>true, "useTestOrchestrator"=>true}, "emulators"=>[{"name"=>"Android GoogleApi Emulator", "orientation"=>"portrait", "platformVersions"=>%w[10.0 11.0]}]}]}
    ...
    it 'should allow android users to create config.yml file for virtual device configurations testing by size' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"espresso", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "espresso"=>{"app"=> File.expand_path("my-demo-app-android/myTestApp.apk"), "testApp"=> File.expand_path("my-demo-app-android/myTestRunner.apk")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{"name"=>"unit-test-123-android googleapi emulator", "testOptions"=>{"size"=>"@LargeTest", "clearPackageData"=>true, "useTestOrchestrator"=>true}, "emulators"=>[{"name"=>"Android GoogleApi Emulator", "orientation"=>"portrait", "platformVersions"=>%w[10.0 11.0]}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should allow android users to execute tests by annotation on virtual devices' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"espresso", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "espresso"=>{"app"=> File.expand_path("my-demo-app-android/myTestApp.apk"), "testApp"=> File.expand_path("my-demo-app-android/myTestRunner.apk")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{"name"=>"unit-test-123-android googleapi emulator", "testOptions"=>{"annotation"=>"com.android.buzz.MyAnnotation", "clearPackageData"=>true, "useTestOrchestrator"=>true}, "emulators"=>[{"name"=>"Android GoogleApi Emulator", "orientation"=>"portrait", "platformVersions"=>%w[10.0 11.0]}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should create real device config.yml file for android platform with test distribution method as shard' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"espresso", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "espresso"=>{"app"=> File.expand_path("my-demo-app-android/myTestApp.apk"), "testApp"=> File.expand_path("my-demo-app-android/myTestRunner.apk")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{"name"=>"unit-test-123-shard 1", "testOptions"=>{"class"=>["com.saucelabs.mydemoapp.android.view.activities.LoginTest"], "clearPackageData"=>true, "useTestOrchestrator"=>true}, "devices"=>[{"name"=>"RDC One", "orientation"=>"portrait", "options"=>{"carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}, "platformVersion"=>"11.0"}]}, {"name"=>"unit-test-123-shard 2", "testOptions"=>{"class"=>["com.saucelabs.mydemoapp.android.view.activities.WebViewTest"], "clearPackageData"=>true, "useTestOrchestrator"=>true}, "devices"=>[{"name"=>"RDC Two", "orientation"=>"portrait", "options"=>{"carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}, "platformVersion"=>"11.0"}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should create real device config.yml file for ios real devices using xcode test target and distribution method set as shard' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"xcuitest", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "xcuitest"=>{"app"=> File.expand_path("my-demo-app-ios/MyTestApp.ipa"), "testApp"=> File.expand_path("my-demo-app-ios/MyTestAppRunner.ipa")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{ "name"=>"unit-test-123-iphone rdc one-shard-1", "testOptions"=>{"class"=>%w[MyDemoAppUITests.NavigationTest MyDemoAppUITests.ProductDetailsTest]}, "devices"=>[{ "name"=>"iPhone RDC One", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}, { "name"=>"unit-test-123-iphone_rdc_two-shard-2", "testOptions"=>{ "class"=>["MyDemoAppUITests.ProductListingPageTest"]}, "devices"=>[{ "id"=>"iphone_rdc_two", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should create real device config.yml file based on xcode test plan using sharding distribution method' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"xcuitest", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "xcuitest"=>{"app"=>File.expand_path("my-demo-app-ios/MyTestApp.ipa"), "testApp"=> File.expand_path("my-demo-app-ios/MyTestAppRunner.ipa")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{ "name"=>"unit-test-123-iphone rdc one-shard-1", "testOptions"=>{"class"=>%w[MyDemoAppUITests.SomeSpec/testOne MyDemoAppUITests.SomeSpec/testTwo MyDemoAppUITests.SomeSpec/testThree]}, "devices"=>[{ "name"=>"iPhone RDC One", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}, { "name"=>"unit-test-123-iphone_rdc_two-shard-2", "testOptions"=>{ "class"=>%w[MyDemoAppUITests.SomeSpec/testFour MyDemoAppUITests.SomeSpec/testFive]}, "devices"=>[{ "id"=>"iphone_rdc_two", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should allow users to specify an array of classes to execute on rdc' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"espresso", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "espresso"=>{"app"=> File.expand_path("my-demo-app-android/myTestApp.apk"), "testApp"=> File.expand_path("my-demo-app-android/myTestRunner.apk")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{ "name"=>"unit-test-123-iphone rdc one", "testOptions"=>{ "class"=>%w[com.some.package.testing.SomeClassOne com.some.package.testing.SomeClassTwo com.some.package.testing.SomeClassThree com.some.package.testing.SomeClassFour], "clearPackageData"=>true, "useTestOrchestrator"=>true}, "devices"=>[{ "name"=>"iPhone RDC One", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}]}
      expect(config).to eql expected_config
    end
    ...
    it 'should allow ios users to specify an array of classes to execute on rdc' do
      ...
      config_folder = File.expand_path("../", "#{__dir__}")
      config = YAML.load_file("#{config_folder}/.sauce/config.yml")
      expected_config = {"apiVersion"=>"v1alpha", "kind"=>"xcuitest", "defaults"=>{"timeout"=>"0"}, "sauce"=>{"region"=>"eu-central-1", "concurrency"=>1, "retries"=>0}, "xcuitest"=>{"app"=> File.expand_path("my-demo-app-ios/myTestApp.app"), "testApp"=> File.expand_path("my-demo-app-ios/myTestRunner.app")}, "artifacts"=>{"download"=>{"when"=>"always", "match"=>["junit.xml"], "directory"=>"./artifacts/"}}, "reporters"=>{"junit"=>{"enabled"=>true}}, "suites"=>[{ "name"=>"unit-test-123-iphone rdc one", "testOptions"=>{"class"=>%w[MyDemoAppUITests.SomeClassOne MyDemoAppUITests.SomeClassTwo MyDemoAppUITests.SomeClassThree MyDemoAppUITests.SomeClassFour]}, "devices"=>[{ "name"=>"iPhone RDC One", "orientation"=>"portrait", "options"=>{ "carrierConnectivity"=>false, "deviceType"=>"PHONE", "private"=>true}}]}]}
      expect(config).to eql expected_config
    end
