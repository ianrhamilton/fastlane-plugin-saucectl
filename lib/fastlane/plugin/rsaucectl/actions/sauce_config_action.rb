  ...
  module Actions
    class SauceConfigAction < Action
      ...
      def self.example_code
        [
          "create config.yml file for android espresso based on user specified virtual device configurations",
          ...
          "create real device config.yml file for android platform with test distribution method as testCase",
          "sauce_config({ platform: 'android',
                         kind: 'espresso',
                         app_path: '#{File.expand_path("my-demo-app-android")}',
                         app_name: 'myTestApp.apk',
          ...
          "create real device config.yml file based on xcode test target using default distribution method (class)",
          "sauce_config({ platform: 'ios',
                         kind: 'xcuitest',
                         app_path: '#{File.expand_path("my-demo-app-ios")}',
                         app_name: 'MyTestApp.ipa',
          ...
          "create real device config.yml file based on xcode test plan using default distribution method (class)",
          "sauce_config({ platform: 'ios',
                         kind: 'xcuitest',
                         app_path: '#{File.expand_path("my-demo-app-ios")}',
                         app_name: 'MyTestApp.ipa',
